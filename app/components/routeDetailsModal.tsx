            ...
            <fetcher.Form method="post" action="/routes/manage" onSubmit={handleSubmit}>
                ...
                <Stack>
                    <TextInput
                        ...
                        name="sector"
                        required
                        defaultValue={route?.sector_id?.toString()}
                    />
                    <TextInput
                        label="Route Name"
                        name="name"
                    ...
                    <TextInput
                        ...
                        name="altName"
                        defaultValue={route?.alt_names?.toString()}
                    />
                    <NumberInput
                        label="Bolt Count"
                        name="boltCount"
                        required
                        min={0}
                        defaultValue={route?.bolt_count?.toString()}
                    />
                    <Select
                        label="Climb Style"
                        name="style"
                        ...
                        defaultValue={route?.climb_style}
                    />
                    <TextInput
                        label="First Ascensionist"
                        name="firstAscensionist"
                        defaultValue={route?.first_ascent_by?.toString()}
                    />
                    <DateInput
                    ...
                    <NumberInput
                        ...
                        required
                        min={0}
                        defaultValue={route?.route_length?.toString()}
                    />
                    <NumberInput
                        label="Sort Order"
                        name="sortOrder"
                        required
                        defaultValue={route?.sort_order?.toString()}
                    />
                    <Group mt="md">
