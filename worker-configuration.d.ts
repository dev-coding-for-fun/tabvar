/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d1e11df58aab7db75cc6b20fbb6db00b)
// Runtime types generated with workerd@1.20260831.1 2024-09-23 nodejs_compat
interface __BaseEnv_Env {
	TABVAR_ISSUES_UPLOADS: R2Bucket;
	TABVAR_TOPOS: R2Bucket;
	DB: D1Database;
	ASSETS: Fetcher;
	route?: "dev.tabvar.org/*";
	TOPOBUILDER_RETURN_TO_ALLOWLIST: "topobuilder:,http://localhost:8081,http://localhost:19006" | "topobuilder:";
	ENVIRONMENT: string;
	BASE_URL: string;
...
declare namespace Cloudflare {
	...
	interface PreviewEnv {
		...
		ASSETS: Fetcher;
		route: "dev.tabvar.org/*";
		TOPOBUILDER_RETURN_TO_ALLOWLIST: "topobuilder:,http://localhost:8081,http://localhost:19006";
		ENVIRONMENT: string;
		BASE_URL: string;
		GOOGLE_CLIENT_ID: string;
		GOOGLE_CLIENT_SECRET: string;
	...
	interface ProductionEnv {
		...
		ASSETS: Fetcher;
		COOKIE_DOMAIN: "tabvar.org";
		TOPOBUILDER_RETURN_TO_ALLOWLIST: "topobuilder:";
		ENVIRONMENT: string;
		BASE_URL: string;
		GOOGLE_CLIENT_ID: string;
		GOOGLE_CLIENT_SECRET: string;
